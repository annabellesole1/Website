    ...
    <section id="contact" className="relative text-gray-400 bg-black body-font">
      <div className="container px-10 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <form
          netlify
          name="contact"
          className="w-full flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          <h2 className="text-white sm:text-4xl text-3xl mb-1 font-medium title-font">
            Hire Me
          </h2>
          <p className="leading-relaxed mb-5">
  I am a hard worker, a fast learner, and an effective communicator, making me a valuable asset to any workplace. I look forward to hearing from you. Feel free to contact me below, or at{" "}
  <a href="mailto:annabellesole1@gmail.com" className="text-blue underline">annabellesole1@gmail.com</a>{" "}
  or{" "}
  <a href="tel:917-991-9925" className="text-blue underline">917-991-9925</a>.
</p>
          ...
          <button
            type="submit"
            className="text-white bg-blue border-0 py-2 px-6 focus:outline-none hover:bg-darkblue rounded text-lg">
            Submit
          </button>
        </form>
      </div>
